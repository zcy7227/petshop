...
public class CreatSql {
    ...
    // @author 值
    private static final String AUTHOR = "mxwbq";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.mx.petshop";
    // xml文件路径
    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + XML_PACKAGE_URL + pc.getModuleName()
